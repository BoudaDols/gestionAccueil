...
<head>
  ...
  <title>Gestion d'accueil | Connexion</title>
  <!-- Favicon -->
              ...
              <form role="form" method="post" action="connexion">
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" placeholder="Nom d'utilisateur" type="text" name="username" id="username" required>
                  </div>
                </div>
      ...
      <div class="row align-items-center justify-content-xl-between">
        <div class="col-xl-6">
          <div class="copyright text-center text-xl-left text-muted">
            &copy; 2018 <a href="https://www.creative-tim.com" class="font-weight-bold ml-1" target="_blank"></a>
          </div>
        </div>
        <div class="col-xl-6">
          <ul class="nav nav-footer justify-content-center justify-content-xl-end">
            ...
            <li class="nav-item">
              <a href="https://www.bcb.bf/presentation.htm" class="nav-link" target="_blank">A Propos de Nous</a>
            </li>
          </ul>
        </div>
      </div>
